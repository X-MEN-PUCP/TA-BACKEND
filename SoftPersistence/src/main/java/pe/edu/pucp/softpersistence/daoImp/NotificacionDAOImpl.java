...
import pe.edu.pucp.softpersistence.dao.NotificacionDAO;
...
public class NotificacionDAOImpl extends DAOImplBase implements NotificacionDAO {
    ...
    public ArrayList<NotificacionDTO> listarPorCuenta(int idCuenta){
        ...
        return (ArrayList<NotificacionDTO>) super.listarTodos(sql,idCuenta,incluirValoresDeParametros,parametros);
    }
